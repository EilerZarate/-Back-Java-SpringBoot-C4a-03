...
class ControladorResultados():
    ...
    def listaCandidatosPartidosyMesas(self):
        return self.repositorioResultados.listadoVotosCandidatoPartidosyMesas()

    def listaCandidatosPartidosxMesa(self,id_mesa):
        return self.repositorioResultados.listadoVotosCandidatoPartidosxMesa(id_mesa)

    def listaPartidosenMesas(self):
        return self.repositorioResultados.listadoPartidosenMesas()

    def listaPartidosxMesa(self,id_mesa):
        return self.repositorioResultados.listadoPartidosxMesa(id_mesa)

    def distribucionCongreso(self):
