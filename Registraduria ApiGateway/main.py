...
def resultadosPorMesa(id_mesa):
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/mesas/'+id_mesa
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
def getConsultaVotosCandidatoPartidoyMesas():
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/listaVotosCandidatoPartidosyMesas'
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
def getConsultaVotosCandidatoPartidoxMesa(id_mesa):
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/listaVotosCandidatoPartidosxMesa'+ id_mesa
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
def getConsultaPartidosMesas():
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/listaVotosPartidosenMesas'
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
def getConsultaPartidosxMesa(id_mesa):
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/listaVotosPartidosxMesa/'+ id_mesa
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
def getComposicionCongreso():
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/composicionNuevoCongreso'
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
